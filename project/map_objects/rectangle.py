...
class Rect: # Define class Rect (short for rectangle)
	def __init__(self, x, y, w, h): # Initialization function being passed x and y coordinates and a (w)idth and a (h)eight. First set of coordinates corresponds to the top left corner of rectangle, second set to the bottom right corner
		self.x1 = x
		self.y1 = y
		self.x2 = x + w
		self.y2 = y + h
