class Level:
	...
	def __init__(self, current_level=1, current_xp=0, level_up_base=200, level_up_factor=150):
		...
		Leveling factor increases amount of XP needed to
		gain levels. More XP needed per level.

		Args:
			current_level: Player's current level.
			current_xp: Player's current XP total.
			level_up_base: Base XP needed to level up.
			level_up_factor: Additional XP needed to level up.
		"""
