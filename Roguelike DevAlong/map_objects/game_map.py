...
class GameMap: # Create new class called GameMap that on initialization creates a 2D array of solid tiles of custom dimensions.
	...
	def make_map(self, max_rooms, room_min_size, room_max_size, map_width, map_height, player): # Define function make_map that takes a max amount of rooms, max and min room dimentions, map width and height, and player, and creates a random with those parameters.
